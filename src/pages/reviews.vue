...
<template>
    <div class="flex-container">
        <img class="profile-picture" src="../public/img/profile-1.jpg">
        ...
        <div class="text-conteiner">
            ...
            <p>{{ testoRecensione }} Lorem ipsum dolor sit amet consectetur adipisicing elit. At excepturi voluptas
                nihil labore quidem, animi culpa quasi esse porro alias voluptatem error! Impedit necessitatibus eveniet
                accusantium facilis doloremque qui architecto?</p>
        </div>
    </div>
</template>
